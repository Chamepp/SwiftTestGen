...
final class TestGenVisitorTests: XCTestCase {
  ...
  override func setUpWithError() throws {
    ...
    func testParseSpecificFile() throws {
        ...
        XCTAssertEqual(parsedTypes[0].functions.map(\.name), ["setupUI", "fetchData"], "FUNCTIONS NAMES NOT MATCHING")
        ...
        XCTAssertEqual(parsedTypes[0].functions[1].returnType, "String", "FUNCTION TYPE RECOGNITION FAILED")
    }
